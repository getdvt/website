...
export const chartPageExtras: ChartDef[] = [
  ...
  "spec": { "geo": { "map": "world" },
            "series": [{ "type": "lines", "coordinateSystem": "geo",
              ...
              "data": [{ "coords": [[-122.42, 37.77], [-0.13, 51.51]] },
                       { "coords": [[-0.13, 51.51], [139.69, 35.69]] }] }] } }`,
  },
  {
    dvtType: 'chart:chord',
    title: 'Chord diagram',
  ...
  "spec": { "series": [{ "type": "graph", "layout": "circular",
              "data": [{ "name": "NA" }, { "name": "EMEA" }, { "name": "APAC" }],
              "links": [{ "source": "NA", "target": "EMEA", "value": 40 },
                        { "source": "EMEA", "target": "APAC", "value": 18 }] }] } }`,
  },
  {
    dvtType: 'chart:map',
    ...
    spec: `{ "type": "chart:map",
  "data": { "rows": [{ "country": "United States", "value": 82 },
                     { "country": "Brazil", "value": 47 },
  ...
  "data": { "rows": [{ "week": "W1", "country": "United States", "value": 0.6 },
                     { "week": "W1", "country": "Germany", "value": 0.9 },
                     { "week": "W1", "country": "Brazil", "value": 0.4 },
                     { "week": "W2", "country": "United States", "value": 0.8 },
                     { "week": "W2", "country": "Germany", "value": 0.7 },
                     { "week": "W2", "country": "Brazil", "value": 0.7 }] },
