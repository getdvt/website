...
const comparison: ChartDef[] = [
  ...
  "data": { "rows": [{ "plan": "Free", "accounts": 40 },
                     { "plan": "Startup", "accounts": 92 },
                     { "plan": "SMB", "accounts": 180 }] },
  ...
  "data": { "rows": [{ "month": "Jan", "starter": 30, "pro": 50 },
                     { "month": "Feb", "starter": 38, "pro": 62 },
                     { "month": "Mar", "starter": 44, "pro": 70 }] },
  "spec": { "series": [
    { "type": "bar", "stack": "plan" },
    { "type": "bar", "stack": "plan" } ] } }`,
  },
  ...
  "spec": { "series": [{ "type": "pictorialBar",
              ...
              "data": [12, 18, 15] }],
            "xAxis": { "type": "category", "data": ["NA", "EMEA", "APAC"] },
            "yAxis": { "type": "value" } } }`,
  },
  {
...
const trend: ChartDef[] = [
  ...
  "spec": { "singleAxis": { "type": "time" },
            "series": [{ "type": "themeRiver",
              "data": [["2026-01-01", 10, "Web"],
                       ["2026-01-01", 6, "Social"],
                       ["2026-02-01", 14, "Web"]] }] } }`,
  },
  {
...
const partToWhole: ChartDef[] = [
  {
    ...
    spec: `{ "type": "chart:pie",
  "data": { "rows": [{ "plan": "Enterprise", "revenue": 1048 },
                     { "plan": "Pro", "revenue": 735 },
                     { "plan": "Team", "revenue": 580 }] },
  ...
  "data": { "rows": [{ "stage": "Signup", "users": 1000 },
                     { "stage": "Activated", "users": 620 },
                     { "stage": "Trial", "users": 310 },
                     { "stage": "Paid", "users": 120 }] },
  "spec": { "categoryField": "stage", "valueField": "users",
            "series": [{ "type": "funnel" }] } }`,
  },
  {
  ...
  "spec": { "series": [{ "type": "treemap",
      "data": [{ "name": "Engineering", "value": 42 },
               { "name": "Sales", "value": 31 },
  ...
  "spec": { "series": [{ "type": "sunburst",
      "data": [{ "name": "NA", "value": 50,
                 "children": [{ "name": "US", "value": 38 }, { "name": "CA", "value": 12 }] },
               { "name": "EMEA", "value": 34 },
               { "name": "APAC", "value": 22 }] }] } }`,
  },
];
...
const correlation: ChartDef[] = [
  ...
  },
  {
    ...
    spec: `{ "type": "chart:scatter",
  "data": { "rows": [{ "spend": 12, "revenue": 40, "deal_size": 8 },
                     { "spend": 22, "revenue": 61, "deal_size": 14 },
                     { "spend": 31, "revenue": 48, "deal_size": 6 }] },
  "spec": { "sizeField": "deal_size", "series": [{ "type": "scatter" }] } }`,
  },
  {
...
const flow: ChartDef[] = [
  ...
  "data": { "rows": [{ "source": "Visit", "target": "Signup", "value": 60 },
                     { "source": "Visit", "target": "Churn", "value": 40 },
                     { "source": "Signup", "target": "Trial", "value": 38 }] },
  "spec": { "sourceField": "source", "targetField": "target", "valueField": "value",
            "series": [{ "type": "sankey" }] } }`,
  },
  {
    dvtType: 'chart:tree',
  ...
  "spec": { "series": [{ "type": "tree", "orient": "LR",
              "data": [{ "name": "Org",
                "children": [{ "name": "GTM" }, { "name": "Product" }] }] }] } }`,
  },
  {
    dvtType: 'chart:graph',
    title: 'Network graph',
  ...
  "spec": { "series": [{ "type": "graph", "layout": "force",
              "data": [{ "name": "dvt" }, { "name": "Warehouse" }, { "name": "Claude" }],
              "links": [{ "source": "dvt", "target": "Warehouse" },
                        { "source": "Claude", "target": "dvt" }] }] } }`,
  },
  {
  ...
  "spec": { "parallelAxis": [{ "dim": 0, "name": "Price" }, { "dim": 1, "name": "Speed" }],
            "series": [{ "type": "parallel",
              "data": [[12, 44], [30, 21], [22, 35]] }] } }`,
  },
];
...
const statistical: ChartDef[] = [
  ...
  "spec": { "series": [{ "type": "boxplot",
              "data": [[14, 28, 40, 55, 78], [20, 34, 48, 60, 84], [8, 22, 33, 47, 66]] }],
            "xAxis": { "type": "category", "data": ["NA", "EMEA", "APAC"] },
            "yAxis": { "type": "value" } } }`,
  },
  {
  ...
  "spec": { "series": [{ "type": "candlestick",
              "data": [[20, 34, 18, 36], [34, 30, 28, 38], [30, 42, 29, 44]] }],
  ...
  "spec": { "radar": { "indicator": [{ "name": "Speed", "max": 100 },
                                     { "name": "Cost", "max": 100 },
                                     { "name": "Scale", "max": 100 }] },
            "series": [{ "type": "radar",
              "data": [{ "name": "Plan A", "value": [80, 60, 90] },
                       { "name": "Plan B", "value": [60, 85, 55] }] }] } }`,
  },
];
...
const animated: ChartDef[] = [
  ...
  "data": { "rows": [{ "quarter": "Q1", "revenue": 20 },
                     { "quarter": "Q2", "revenue": 32 },
                     { "quarter": "Q3", "revenue": 28 }] },
